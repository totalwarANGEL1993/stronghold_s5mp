...
Stronghold.Text = {
    ...
    BlackKnight = {
        [1] = {de = "Schwarzer Ritter",
               en = "Black Knight"},
        [2] = {de = "Edler Schwarzer Ritter",
               en = "Noble Black Knight"},
    },
    Barbarian = {
        [1] = {de = "Barbaren @bs krieger",
               en = "Barbarian Warrior"},
        [2] = {de = "Elitekrieger der Barbaren",
               en = "Elite Barbarian Warrior"},
    },
    Spearman = {
        [1] = {de = "Speerträger",
               en = "Spearman"},
