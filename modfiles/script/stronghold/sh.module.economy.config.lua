...
Stronghold.Economy.Config.Resource = {
    ...
    Mining = {
        ...
        [Entities.PB_LoggingCamp1] = 4,
        [Entities.PB_LoggingCamp2] = 5,
        [Entities.PB_LoggingCamp3] = 6,
...
Stronghold.Economy.Config.Income = {
    ...
    Rations = {
        [0] = {Honor = 0.5, Reputation = 0, Stamina = 0.50},
        [1] = {Honor = 1.0, Reputation = 0, Stamina = 0.39},
        [2] = {Honor = 1.5, Reputation = 0, Stamina = 0.28},
        [3] = {Honor = 2.0, Reputation = 0, Stamina = 0.17},
        [4] = {Honor = 2.5, Reputation = 0, Stamina = 0.06},
    },
    SleepTime = {
        [0] = {Honor = 0, Reputation = 0.5, Stamina = 0.50},
        [1] = {Honor = 0, Reputation = 1.0, Stamina = 0.39},
        [2] = {Honor = 0, Reputation = 1.5, Stamina = 0.28},
        [3] = {Honor = 0, Reputation = 2.0, Stamina = 0.17},
        [4] = {Honor = 0, Reputation = 2.5, Stamina = 0.06},
    },
    Beverage = {
        [0] = {Honor = 0, Reputation = 1.0, Stamina = 0.50},
        [1] = {Honor = 0, Reputation = 2.0, Stamina = 0.39},
        [2] = {Honor = 0, Reputation = 3.0, Stamina = 0.28},
        [3] = {Honor = 0, Reputation = 4.0, Stamina = 0.17},
        [4] = {Honor = 0, Reputation = 5.0, Stamina = 0.06},
    },
    Festival = {
    ...
    TechnologyEffect = {
        [Technologies.T_CropCycle]   = {
            [Entities.PB_Farm1]      = {Honor = 0.25, Reputation = 0,},
            [Entities.PB_Farm2]      = {Honor = 0.25, Reputation = 0,},
            [Entities.PB_Farm3]      = {Honor = 0.25, Reputation = 0,},
        },
        ...
        [Technologies.T_Hearthfire]  = {
            [Entities.PB_Residence1] = {Honor = 0, Reputation = 0.25,},
            [Entities.PB_Residence2] = {Honor = 0, Reputation = 0.25,},
            [Entities.PB_Residence3] = {Honor = 0, Reputation = 0.25,},
        },
    ...
    Dynamic = {
        ...
        [Entities.PB_Farm2]      = {Honor = 1.0, Reputation = 0,},
        [Entities.PB_Farm3]      = {Honor = 1.0, Reputation = 0,},
        --
        [Entities.PB_Residence1] = {Honor = 0, Reputation = 1.0,},
        [Entities.PB_Residence2] = {Honor = 0, Reputation = 1.0,},
        [Entities.PB_Residence3] = {Honor = 0, Reputation = 1.0,},
        --
        [Entities.PB_Tavern1]    = {Honor = 1.0, Reputation = 1.0,},
        [Entities.PB_Tavern2]    = {Honor = 1.0, Reputation = 1.0,},
    },
    Static = {
