...
Stronghold.Economy.Config.Income = {
    ...
    Rations = {
        [0] = {Honor = nil, Reputation = -4, Stamina = 0.5},
        [1] = {Honor = nil, Reputation = -2, Stamina = 0.4},
        [2] = {Honor = 1, Reputation = nil, Stamina = 0.3},
        [3] = {Honor = 2, Reputation = nil, Stamina = 0.2},
        [4] = {Honor = 3, Reputation = nil, Stamina = 0.1},
    },
    SleepTime = {
        [0] = {Honor = nil, Reputation = -4, Stamina = 0.5},
        [1] = {Honor = nil, Reputation = -2, Stamina = 0.4},
        [2] = {Honor = nil, Reputation = 1, Stamina = 0.3},
        [3] = {Honor = nil, Reputation = 2, Stamina = 0.2},
        [4] = {Honor = nil, Reputation = 3, Stamina = 0.1},
    },
    Beverage = {
        [0] = {Honor = nil, Reputation = 1, Stamina = 0.5},
        [1] = {Honor = nil, Reputation = 2, Stamina = 0.4},
        [2] = {Honor = nil, Reputation = 3, Stamina = 0.3},
        [3] = {Honor = nil, Reputation = 4, Stamina = 0.2},
        [4] = {Honor = nil, Reputation = 5, Stamina = 0.1},
    },
    ...
    TechnologyEffect = {
        [Technologies.T_CropCycle]   = {
            ...
            [Entities.PB_Farm3]      = {Honor = 1.5, Reputation = 0,},
        },
        ...
        [Technologies.T_Hearthfire]  = {
            ...
            [Entities.PB_Residence3] = {Honor = 0, Reputation = 1.5,},
        },
